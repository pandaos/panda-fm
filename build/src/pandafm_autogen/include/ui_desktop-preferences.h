...
#include <libpandafm/colorbutton.h>
#include <libpandafm/fontbutton.h>
...
public:
    ...
    {
        DesktopPreferencesDialog->setWindowTitle(QApplication::translate("DesktopPreferencesDialog", "Desktop Preferences", nullptr));
        groupBox_5->setTitle(QApplication::translate("DesktopPreferencesDialog", "Icons", nullptr));
        label_9->setText(QApplication::translate("DesktopPreferencesDialog", "Icon size:", nullptr));
        groupBox->setTitle(QApplication::translate("DesktopPreferencesDialog", "Label Text", nullptr));
        label_2->setText(QApplication::translate("DesktopPreferencesDialog", "Select font:", nullptr));
        font->setText(QString());
        label_3->setText(QApplication::translate("DesktopPreferencesDialog", "Select text color:", nullptr));
        textColor->setText(QString());
        label_4->setText(QApplication::translate("DesktopPreferencesDialog", "Select shadow color:", nullptr));
        shadowColor->setText(QString());
        groupBox_3->setTitle(QApplication::translate("DesktopPreferencesDialog", "Spacing", nullptr));
        label_7->setText(QApplication::translate("DesktopPreferencesDialog", "Minimum item margins:", nullptr));
#ifndef QT_NO_TOOLTIP
        hMargin->setToolTip(QApplication::translate("DesktopPreferencesDialog", "3 px by default.", nullptr));
#endif // QT_NO_TOOLTIP
        hMargin->setSuffix(QApplication::translate("DesktopPreferencesDialog", " px", nullptr));
        label_8->setText(QApplication::translate("DesktopPreferencesDialog", "x", nullptr));
#ifndef QT_NO_TOOLTIP
        vMargin->setToolTip(QApplication::translate("DesktopPreferencesDialog", "1 px by default.\n"
"A space is also reserved for 3 lines of text.", nullptr));
#endif // QT_NO_TOOLTIP
        vMargin->setSuffix(QApplication::translate("DesktopPreferencesDialog", " px", nullptr));
        lockMargins->setText(QApplication::translate("DesktopPreferencesDialog", "Lock", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(generalPage), QApplication::translate("DesktopPreferencesDialog", "General", nullptr));
        groupBox_2->setTitle(QApplication::translate("DesktopPreferencesDialog", "Background", nullptr));
        label_5->setText(QApplication::translate("DesktopPreferencesDialog", "Select background color:", nullptr));
        backgroundColor->setText(QString());
        groupBox_4->setTitle(QApplication::translate("DesktopPreferencesDialog", "Wallpaper", nullptr));
        label->setText(QApplication::translate("DesktopPreferencesDialog", "Wallpaper mode:", nullptr));
        label_6->setText(QApplication::translate("DesktopPreferencesDialog", "Wallpaper image file:", nullptr));
#ifndef QT_NO_TOOLTIP
        imageFile->setToolTip(QApplication::translate("DesktopPreferencesDialog", "Image file", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        imageFile->setStatusTip(QString());
#endif // QT_NO_STATUSTIP
        imageFile->setPlaceholderText(QApplication::translate("DesktopPreferencesDialog", "Image file path", nullptr));
        browse->setText(QApplication::translate("DesktopPreferencesDialog", "&Browse", nullptr));
        transformImage->setText(QApplication::translate("DesktopPreferencesDialog", "Transform image based on EXIF data", nullptr));
        perScreenWallpaper->setText(QApplication::translate("DesktopPreferencesDialog", "Individual wallpaper for each monitor", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(bgPage), QApplication::translate("DesktopPreferencesDialog", "Background", nullptr));
        slideShow->setTitle(QApplication::translate("DesktopPreferencesDialog", "Enable Slide Show", nullptr));
        label_10->setText(QApplication::translate("DesktopPreferencesDialog", "Wallpaper image folder:", nullptr));
        folderBrowse->setText(QApplication::translate("DesktopPreferencesDialog", "Browse", nullptr));
        hours->setSuffix(QApplication::translate("DesktopPreferencesDialog", " hour(s)", nullptr));
        label_12->setText(QApplication::translate("DesktopPreferencesDialog", "and", nullptr));
#ifndef QT_NO_TOOLTIP
        label_11->setToolTip(QApplication::translate("DesktopPreferencesDialog", "Intervals less than 5min will be ignored", nullptr));
#endif // QT_NO_TOOLTIP
        label_11->setText(QApplication::translate("DesktopPreferencesDialog", "Interval:", nullptr));
        minutes->setSuffix(QApplication::translate("DesktopPreferencesDialog", " minute(s)", nullptr));
        imageFolder->setPlaceholderText(QApplication::translate("DesktopPreferencesDialog", "Wallpaper folder", nullptr));
        randomize->setText(QApplication::translate("DesktopPreferencesDialog", "Randomize the slide show", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(slidePage), QApplication::translate("DesktopPreferencesDialog", "Slide Show", nullptr));
        groupBox_6->setTitle(QApplication::translate("DesktopPreferencesDialog", "Visible Shortcuts", nullptr));
        homeBox->setText(QApplication::translate("DesktopPreferencesDialog", "Home", nullptr));
        trashBox->setText(QApplication::translate("DesktopPreferencesDialog", "Trash", nullptr));
        computerBox->setText(QApplication::translate("DesktopPreferencesDialog", "Computer", nullptr));
        networkBox->setText(QApplication::translate("DesktopPreferencesDialog", "Network", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(advancedPage), QApplication::translate("DesktopPreferencesDialog", "Advanced", nullptr));
    } // retranslateUi
