...
public:
    ...
    {
        AutoRunDialog->setWindowTitle(QApplication::translate("AutoRunDialog", "Removable medium is inserted", nullptr));
        icon->setText(QString());
        label->setText(QApplication::translate("AutoRunDialog", "<b>Removable medium is inserted</b>", nullptr));
        label_2->setText(QApplication::translate("AutoRunDialog", "Type of medium:", nullptr));
        mediumType->setText(QApplication::translate("AutoRunDialog", "Detecting...", nullptr));
        label_3->setText(QApplication::translate("AutoRunDialog", "Please select the action you want to perform:", nullptr));
    } // retranslateUi
